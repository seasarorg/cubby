 ...
 * 
 */
public class CubbyConfigurationImpl implements CubbyConfiguration, Disposable {
	...
	private void initialize() {
		if (!this.initialized) {
			...
			if (root.hasComponentDef(FormatPattern.class)) {
				...
				this.formatPattern = (FormatPattern) componentDef
						.getComponent();
				if (logger.isDebugEnabled()) {
