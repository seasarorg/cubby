...
public class TemplateTag extends DynamicAttributesTagSupport {
	...
	public void doTag() throws JspException, IOException {
		Object parts = getJspContext().findAttribute("parts");
		getJspContext().setAttribute("parts", parts, PageContext.REQUEST_SCOPE);
	    @SuppressWarnings("unused")
		JspWriter out = getJspContext().getOut();
	    final ImportTag importTag = new ImportTag();
		importTag.setPageContext(getPageContext());
	    importTag.setParent(new javax.servlet.jsp.tagext.TagAdapter((javax.servlet.jsp.tagext.SimpleTag) this ));
	    importTag.setUrl(extend);
	    int[] _jspx_push_body_count_c_import_0 = new int[] { 0 };
	    try {
	      if (importTag.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
