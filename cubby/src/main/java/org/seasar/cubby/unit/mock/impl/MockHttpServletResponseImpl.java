...
import org.seasar.cubby.unit.mock.MockHttpServletResponse;
...
public class MockHttpServletResponseImpl implements MockHttpServletResponse{
	...
	private PrintWriter writer = MockUtils.getResponseWriter();

	private ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();

	private ServletOutputStream outputStream = MockUtils.getServletOutputStream(byteArrayOutputStream);
	...
	public Enumeration getHeaders(String name) {
		...
		if (values != null) {
			return MockUtils.toEnumeration(values.iterator());
		}
		return MockUtils.emptyEnumeration();
	}
	...
	public Enumeration getHeaderNames() {
		return MockUtils.toEnumeration(headers.keySet().iterator());
	}
	...
	public void setDateHeader(String name, long value) {
		setHeader(name, MockUtils.toDate(value));
	...
	public void addDateHeader(String name, long value) {
		addHeader(name, MockUtils.toDate(value));
	}
