...
public interface ClassFinder {
    ...
    void find(ServletContext context, boolean enableJar);

    void find(ServletContext context, boolean enableJar, String pattern);

    Collection<Class> getClassCollection();
