...
<ul>
	<li>
		<t:link tag="a" attr="href"
				actionClass="org.seasar.cubby.showcase.other.web.link.LinkAction"
				actionMethod="foo">
			hyper reference (simple)
		</t:link>
		- link to "<t:link actionClass="org.seasar.cubby.showcase.other.web.link.LinkAction" actionMethod="foo" />"
	</li>
	<li>
		<t:link tag="a" attr="href"
				actionClass="org.seasar.cubby.showcase.other.web.link.LinkAction"
		...
		- link to "<t:link actionClass="org.seasar.cubby.showcase.other.web.link.LinkAction" actionMethod="bar">
			<t:param name="id" value="123" />
			<t:param name="token" value="abc" />
		</t:link>"
	</li>
	<li>
		<t:link tag="a" attr="href"
			...
			<t:link tag="img" attr="src"
					actionClass="org.seasar.cubby.showcase.other.web.link.ImageAction"
					actionMethod="image">
