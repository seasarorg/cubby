...
public class DefaultBeanDescProviderPropertyTest {
	...
	public void invalidProperty() throws Exception {
		...
		assertTrue(beanDesc.hasPropertyAttribute("aaa"));
		assertTrue(beanDesc.hasPropertyAttribute("bbb"));
		assertTrue(beanDesc.hasFieldAttribute("aaa"));
		assertTrue(beanDesc.hasFieldAttribute("bbb"));
		Attribute aaa = beanDesc.getPropertyAttribute("aaa");
		assertTrue(aaa.isReadable());
		assertTrue(aaa.isWritable());
		Attribute bbb = beanDesc.getPropertyAttribute("bbb");
