package org.seasar.cubby.gae.filter;
...
import org.seasar.cubby.gae.internal.controller.impl.GaeActionProcessorImpl;
...
public class GaeCubbyFilter implements Filter {
	...
	/** アクションを処理します。 */
	private final ActionProcessor actionProcessor = new GaeActionProcessorImpl();
